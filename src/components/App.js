              ...
              >
                ...
                <div className="container">
                  <div className="content-center">
                    ...
                    <div className="h2 title">Gerardo Hern&aacute;ndez</div>
                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="card-body">
                      ...
                      <p>
                        ...
                        Pellentesque in ipsum id orci porta dapibus. Praesent
                        sapien massa, convallis a pellentesque nec, egestas non
                        nisi. Vestibulum ante ipsum primis in faucibus orci
                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="card-body">
                      ...
                      <div className="row mt-3">
                        ...
                        <div className="col-sm-8">contact@gerardohp.dev</div>
                      </div>
                      <div className="row mt-3">
                        <div className="col-sm-4">
                          <strong className="text-uppercase">Phone:</strong>
                        </div>
                        <div className="col-sm-8">+52 477-123-4567</div>
                      </div>
                      <div className="row mt-3">
                        <div className="col-sm-4">
                      ...
                      <div className="row mt-3">
                        ...
                        <div className="col-sm-8">English, Spanish</div>
                      </div>
                    </div>
                  </div>
                </div>
